...
import { addItemToWishlist, removeItemFromWishlist } from "../../rtk/slices/authSlice";
    ...
    <div className="bg-white shadow-md mt-10 max-w-[430px] w-[100%]">
      <div className="relative">
        ...
        <div className="flex justify-between px-3 -mt-12">
          {items?.Hot && (
            <span className="py-1 px-3 text-white bg-red-500 rounded">Hot</span>
          )}
          {items?.Trendy && (
        ...
        <div className="flex flex-col gap-2 p-5">
          <Link
            ...
            className="text-[17px] md:text-[19px]  font-bold hover:text-secondary-color p-0 my-3"
          >
            {items?.name}
          </Link>
          ...
          <div className="flex gap-2 my-2">
            <div className="font-bold">
              <p className="mb-2 text-[12px] md:text-[14px]">Bedrooms</p>
            ...
            <div className="font-bold">
              <p className="mb-2 text-[12px] md:text-[14px]">Bathrooms</p>
              <p className="flex items-center gap-2">
                <svg
                  className="ov-icon text-text-secondary text-[2.16em]"
                  aria-hidden="true"
            ...
            <div className="font-bold">
              <p className="mb-2 text-[12px] md:text-[14px]">Area</p>
              <p className="flex items-center gap-2">
                <svg
                  className="ov-icon text-text-secondary text-[2.16em]"
                  aria-hidden="true"
